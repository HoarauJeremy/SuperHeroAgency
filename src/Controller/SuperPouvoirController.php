...
{
    #[Route(name: 'app_super_pouvoir_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_super_pouvoir_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_super_pouvoir_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_super_pouvoir_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_super_pouvoir_delete', methods: ['POST'])]
