 ...
 */
final class Version20241128122017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission ADD equipe_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mission ADD CONSTRAINT FK_9067F23C6D861B89 FOREIGN KEY (equipe_id) REFERENCES equipe (id)');
        $this->addSql('CREATE INDEX IDX_9067F23C6D861B89 ON mission (equipe_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE mission DROP FOREIGN KEY FK_9067F23C6D861B89');
        ...
        $this->addSql('DROP INDEX IDX_9067F23C6D861B89 ON mission');
        $this->addSql('ALTER TABLE mission DROP equipe_id');
    }
}
